...
export default function HeroPage() {
  return (
    // <div>
    //   <div
    //   //  className="md:w-screen flex justify-center items-center bg-[url('/images/hero4.jpg')]  md:h-[716px] "
    //   className="md:w-screen flex justify-center items-center bg-[url('/images/hero4.jpg')] bg-cover bg-center md:h-[716px]"
