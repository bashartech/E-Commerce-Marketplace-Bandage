...
// interface Product {
//     productName: string | null; // Allow null values
//     price: number | null;
...
//           orderItems[]{productName, price, quantity} // ✅ Fetches all products
//         }`;

//         const response = await client.fetch(query);
//         console.log("Fetched Data:", response); // ✅ Debugging step

//         // ✅ Flattening the nested orderItems array
//         const allProducts = response
//         .filter((order:any) => order.orderItems) // ✅ Ensure orderItems exists
//         .flatMap((order:any) => order.orderItems || []); // ✅ Flatten orderItems
...
// import { client } from "@/sanity/lib/client"
// import { BarChart3, Package, TrendingUp, Menu, X } from 'lucide-react'
